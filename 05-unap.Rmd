...
ggplot2:::ggplot.data.frame(data, aes(grp, t*P/(3.600*3.7))) + geom_col(aes(fill=state)) + 
...
ggplot2:::ggplot.data.frame(subset(data, grp!="w/o algorithm"), aes(STA, t/activity, fill=state)) + 
...
ggplot2:::ggplot.data.frame(datae, aes(STA, consumption, fill=forcats::fct_rev(decomposition))) + geom_col(width=1) +
...
(ggplot2:::ggplot.data.frame(data, aes(rate, app, fill=factor(tsleep), color=factor(tsleep))) + 
